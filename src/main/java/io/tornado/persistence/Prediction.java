...
public class Prediction {
    public static final int LEGACY_SIGNAL_VERSION=2;
    public static final int CURRENT_SIGNAL_VERSION=3;
    ...
    @Column(nullable=false) private int signalVersion=LEGACY_SIGNAL_VERSION;
    ...
    public void markUngradable(Instant at){if(outcome!=Outcome.PENDING)throw new IllegalStateException("Only pending predictions can be marked ungradable");outcome=Outcome.UNGRADABLE;gradedAt=at;}
