...
public enum StrategyDefinition {
    ...
    ROC_12("ROC(12)",s->zeroMomentum(new ROCIndicator(new ClosePriceIndicator(s),12))),
    CHAIKIN_MONEY_FLOW("Chaikin Money Flow(20)",s->zeroMomentum(new ChaikinMoneyFlowIndicator(s,20))),
