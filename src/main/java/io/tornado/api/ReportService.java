...
public class ReportService {
    ...
    private java.math.BigDecimal target(int level){if(level<1||level>3)throw new IllegalArgumentException("tpLevel must be 1, 2, or 3");return (settings==null?TpSlLevels.defaults():settings.findById(1).orElseThrow().getTpSlLevels()).tp(level).movePointLeft(2);}
