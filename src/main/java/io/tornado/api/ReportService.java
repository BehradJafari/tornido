...
public class ReportService {
    ...
    private List<Prediction> filter(List<Prediction> source,long horizon){requireSupportedHorizon(horizon);return source.stream().filter(p->p.getHorizonSeconds()==horizon).toList();}
