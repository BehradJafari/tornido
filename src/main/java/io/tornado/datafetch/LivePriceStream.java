...
public class LivePriceStream {
    ...
    private final CoinRepository coins; private final TornadoProperties props; private final ObjectMapper json;
    ...
    public LivePriceStream(CoinRepository coins,TornadoProperties props,ObjectMapper json){this.coins=coins;this.props=props;this.json=json;}
