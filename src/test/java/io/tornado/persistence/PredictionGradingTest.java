...
class PredictionGradingTest {
    ...
    @Test void neutralObservationCannotBeGraded(){var neutral=prediction(Direction.NEUTRAL);org.assertj.core.api.Assertions.assertThatThrownBy(()->neutral.grade(new BigDecimal("101"),Instant.now(),new BigDecimal("0.003"))).isInstanceOf(IllegalStateException.class);}
}
